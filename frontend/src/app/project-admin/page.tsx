...
export default function ProjectAdminDashboard() {
    ...
    setTeamMembers([
      {
        ...
        permissions: ["view_tickets", "reply_to_tickets", "view_knowledge_base"]
      },
      {
        id: "2",
        name: "Jane Smith",
        ...
        permissions: ["view_tickets", "reply_to_tickets", "view_knowledge_base", "manage_team", "view_analytics"]
      }
    ]);
  ...
  const openClientPortal = (projectId: string) => {
    // Navigate to client dashboard with project context
    router.push(`/client-dashboard?project=${projectId}&view=admin`);
  };
      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-white/80">Manage your help desk projects</p>
          </div>
          <Button 
